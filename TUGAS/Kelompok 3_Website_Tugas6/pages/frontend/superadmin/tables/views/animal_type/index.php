...
$queryUsr = "SELECT * FROM `animal_type`";
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                <button
                                                                                    onclick="setFormDelete('<?= $data['at_id'] ?>', '<?= $data['at_description'] ?>')"
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body smd-form">
                                    <form role="form" method="post" action="">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="at_description"
                                                placeholder="Description" name="at_description">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body smd-form">
                                    <form role="form" method="post" action="">
                                        <input type="hidden" class="form-control" id="at_id" name="at_id">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="at_description"
                                                placeholder="Description" name="at_description">
                                        </div>
...
<script>
    function setFormEdit(encodedData) {
        try {
            ...
            form.querySelector('#at_description').value = data.at_description;
    ...
    function setFormDelete(id, name) {
        ...
        deleteForm.querySelector("#at_id").value = id;
