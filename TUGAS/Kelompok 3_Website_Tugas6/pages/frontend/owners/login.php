...
<div class="container-fluid d-flex align-items-center min-vh-100">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="login-container">
                    ...
                    <form>
                        ...
                        <button type="button" class="btn btn-login btn-primary" id="loginOwner">MASUK</button>
                    </form>
    ...
    <script>
    $("#loginOwner").on("click", function() {
        let data = {
            username: $('#username').val(),
            password: $('#password').val()
        }

        $.post("./../../backend/auth/owner/login.php", data, function(response) {
