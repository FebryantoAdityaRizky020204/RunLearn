...
$query = "SELECT * FROM visit v
          ...
          INNER JOIN visit_drug vd on v.visit_id = vd.visit_id
          INNER JOIN drug d on vd.drug_id = d.drug_id";
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./resep_obat.php">Resep Obat</a>
                </li>
                <li class="nav-item">
...
<main class="container">
  <div class="row justify-content-center">
    <div class="col-md-8 mt-5">
                <h1 class="mb-3">Obat Hewan</h1>
                <button class="btn text-primary">Tambah Obat</button>
