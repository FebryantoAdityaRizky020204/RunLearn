...
<div class="container-fluid d-flex align-items-center min-vh-100">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="login-container">
                    ...
                    <form>
                        ...
                        <button type="button" class="btn btn-login btn-primary" id="loginDokter">MASUK</button>
                    </form>
    ...
    $("#loginDokter").on("click", function() {
        ...
        $.post("./../../backend/auth/dokter/login.php", data, function(response) {
