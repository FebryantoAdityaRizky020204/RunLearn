...
$query = "SELECT * FROM animal a
          INNER JOIN animal_type t on a.at_id = a.at_id
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./kelola_kunjungan.php">Kelola Kunjungan</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 mt-5">
                <h1 class="mb-3">Riwayat Kunjungan</h1>
                <button class="btn text-primary">Tambah Kunjungan</button>
                ...
                <table class="table table-bordered table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn text-primary">Obat</button>
