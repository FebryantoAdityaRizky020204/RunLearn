...
$queryUsr = "SELECT * FROM `specialisation`";
try {
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="header-text">
                            <h4>TABEL <em>SPECIALISATION</em></h4>
                        </div>
                    </div>
                </div>
            </div>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                <button
                                                                                    onclick="setFormDelete('<?= $data['spec_id'] ?>', '<?= $data['spec_description'] ?>')"
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body smd-form">
                                    <form role="form" method="post" action="">
                                        <input type="hidden" class="form-control" id="spec_id" name="spec_id">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="spec_description"
                                                placeholder="Spec. Description" name="spec_description">
                                        </div>
