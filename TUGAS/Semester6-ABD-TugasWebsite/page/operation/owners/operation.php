...
class Operation
{
    ...
    public function update($data) {
        ...
        if(!empty($data)){
            ...
            $query = "UPDATE `owners` SET `owner_givenname`='$owner_givenname',`owner_familyname`='$owner_familyname',`owner_address`='$owner_address',`owner_phone` = AES_ENCRYPT('$owner_phone', 'adit') WHERE `owner_id` = $owner_id";
